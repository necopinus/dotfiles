...
# Confirm that we've finished part 2.
#
echo "This script should *only* be run after Google Drive has been fully"
echo "synced to this machine. IF THIS STEP IS NOT YET FINISHED USE CTRL+C TO"
echo "EXIT NOW!"
echo ""
