    ...
    functions =
      {
        ...
        nono = ''
          ...
          if test -z "$NEW_PATH"
            ...
            set NEW_PATH_UNSET ""
            set NEW_PATH_SET "PATH=\"$NEW_PATH\""
          end
          ...
          if test -z "$NEW_MANPATH"
            ...
            set NEW_MANPATH_SET "MANPATH=\"$NEW_MANPATH\""
          end
          ...
          if test -z "$NEW_XDG_CONFIG_DIRS"
            ...
            set NEW_XDG_CONFIG_DIRS_SET "XDG_CONFIG_DIRS=\"$NEW_XDG_CONFIG_DIRS\""
          end
          ...
          if test -z "$NEW_XDG_DATA_DIRS"
            ...
            set NEW_XDG_DATA_DIRS_SET "XDG_DATA_DIRS=\"$NEW_XDG_DATA_DIRS\""
          end
